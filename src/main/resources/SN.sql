...
insert into access_role values (1, 'ADMIN');
insert into access_role values (2, 'USER');
...
insert into `user` values (1, 'rogE', '55555', '1998-05-26', 'Egor', 'Perehodko', 
'roge55555@gmail.com', '+375293039973', 1, true, false, '2021-06-24', null, 
'nothing special', 'sysadmin', '+375293039973');
insert into `user` values (2, 'CtrogE', '131313', '1998-05-13', 'Roge', 'Ctrannik', 
'ctrannik555@gmail.com', '+375333236700', 1, true, false, '2021-06-24', 'vk.com', 
null, null, '+375333236700');
insert into `user` values (3, 'Roma666', '54862', '1999-03-18', 'Romann', 'Ranshov', 
'sportzman@gmail.com', '+375293486999', 2, true, false, '2021-06-28', 'linkedin.com/rmn18', 
...
insert into profile_comment values (1, 1, 2, '2021-07-05 11:23:50', 'first comment');
insert into profile_comment values (2, 2, 3, '2021-07-05 20:34:47', 'second comment');
...
insert into community values (2, 2, 'free community', 'description.....', '2021-07-10');
