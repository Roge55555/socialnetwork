...
class CommunityServiceTest {
    ...
    void successAdd() {
        ...
        Assertions.assertEquals(communityService.findById(check.getId() + 1), community);
    }
    ...
    void findByIdSuccess() {
        final List<Community> communities = communityService.findAll();
        Assertions.assertEquals(communities.get(0), communityService.findById(1L));
    }
    ...
    void findByNameSuccess() {
        final List<Community> communities = communityService.findAll();
        Assertions.assertEquals(communities.get(0), communityService.findByName("admin`s home"));
    }
