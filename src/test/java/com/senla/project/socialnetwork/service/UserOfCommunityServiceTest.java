...
class UserOfCommunityServiceTest {
    ...
    void successAdd() {
        ...
        assertEquals(userOfCommunityService.findByCommunityIdAndUserId(2L, 1L), existedSubscriber);
    }
    ...
    void findAllCommunitiesOfUser() {
        ...
        assertAll(() -> assertEquals(3L, userOfCommunities.get(0).getCommunity().getId()),
                () -> assertEquals(Utils.getLogin(), userOfCommunities.get(0).getUser().getLogin()),
    ...
    void findByCommunityNameAndUserLoginSuccess() {
        ...
        assertEquals(userOfCommunityService.add(getUserOfCommunity(4L, 6L)), userOfCommunityService.findByCommunityNameAndUserLogin("FilmLover", "runsha").get());
    }
    ...
    void findByCommunityIdAndUserIdSuccess() {
        getAuthentication("$a$ha", "sava997");
        assertEquals(userOfCommunityService.add(getUserOfCommunity(4L, 6L)), userOfCommunityService.findByCommunityIdAndUserId(4L, 6L));
    }
